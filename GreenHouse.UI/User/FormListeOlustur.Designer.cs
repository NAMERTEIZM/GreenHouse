...
{
	partial class FormListeOlustur
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Liste olustur";
			...
			this.Name = "FormListeOlustur";
			this.Text = "FormListeOlustur";
