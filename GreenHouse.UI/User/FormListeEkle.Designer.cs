namespace GreenHouse.UI.User
{
	partial class FormListeEkle
	{
		...
		private void InitializeComponent()
		{
			...
			this.listBox1.Location = new System.Drawing.Point(106, 95);
			this.listBox1.Name = "listBox1";
			this.listBox1.Size = new System.Drawing.Size(541, 186);
			this.listBox1.TabIndex = 0;
			// 
			// comboBox1
			// 
			this.comboBox1.FormattingEnabled = true;
			this.comboBox1.Location = new System.Drawing.Point(407, 44);
			...
			this.label1.Text = "Eklenecek tip";
			// 
			// comboBox2
			// 
			...
			this.Name = "FormListeEkle";
			this.Text = "Listeye ekleme ekrani";
